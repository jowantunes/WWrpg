...
export const RELATION_RULES = {
  personagem: ["local", "organizacao", "item", "personagem", "criatura", "evento"],
  local: ["personagem", "organizacao", "evento", "item", "criatura"],
  organizacao: ["personagem", "local", "evento", "item"],
  evento: ["personagem", "local", "organizacao", "item", "criatura"],
  item: ["personagem", "local", "evento", "organizacao"],
  criatura: ["local", "personagem", "evento"]
};