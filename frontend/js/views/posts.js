...
async function _refreshList(container, pagina, tipo) {
  ...
  container.innerHTML = `
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;">
      ...
      ${state.canWrite() ? `<button class="btn-limiar btn-primary btn-novo-post" style="font-size:13px;">+ Novo Post</button>` : ""}
    </div>
  ...
  // ── New post button
  const btnNovo = container.querySelector(".btn-novo-post");
  if (btnNovo) {
